...
const weightTraining1to1 = 1500;
const sprotBudget = 3000;
...
function AlexBuyLesson() {
  let AlexYogaGroup = 0;
  let AlexWeightTrainingGroup = 0;
  let AlexweightTraining1to1 = 0;
  const AlexBudget = 3000;
  const condition1 = ((AlexWeightTrainingGroup = 1) || (AlexYogaGroup = 1));
  const condition2 = AlexYogaGroup * yogaGroup + AlexWeightTrainingGroup * weightTrainingGroup + <= sprotBudget
  const condition3 = 
